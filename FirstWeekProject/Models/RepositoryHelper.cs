namespace FirstWeekProject.Models
{
	public static class RepositoryHelper
	{
		...
		public static View_ClientRepository GetView_ClientRepository()
		{
			var repository = new View_ClientRepository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static View_ClientRepository GetView_ClientRepository(IUnitOfWork unitOfWork)
		{
			var repository = new View_ClientRepository();
			repository.UnitOfWork = unitOfWork;
			return repository;
